...
def apply_theme(root: tk.Misc) -> None:
    ...
    style.configure("SmallStatValue.TLabel", background=COLORS["notice"], foreground=COLORS["text"], font=("Segoe UI", 13, "bold"))
    style.configure("SmallStatLabel.TLabel", background=COLORS["notice"], foreground=COLORS["muted"], font=("Segoe UI", 9))
